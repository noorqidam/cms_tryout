!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e) {
      function n(t, e) {
        return (
          !!(e = null == e ? o : e) && ("number" == typeof t || r.test(t)) && t > -1 && t % 1 == 0 && t < e
        );
      }
          ...
          return (
            ...
            (i.onUpdate = function() {
              if (i.display && i.img) {
                ...
                if (((i.display.innerHTML = t.join(" &times; ")), t[0] > 120 && t[1] > 30))
                  Object.assign(i.display.style, { right: "4px", bottom: "4px", left: "auto" });
        ...
        b = (function(t) {
          function e() {
            ...
            return (
              (n = i = r(
                this,
                (t = e.__proto__ || Object.getPrototypeOf(e)).call.apply(t, [this].concat(l))
              )),
              (i.onCreate = function() {
        ...
        f = function t(e) {
          ...
          o(this, t),
            ...
            (this.checkImage = function(t) {
              n.img &&
                ((46 != t.keyCode && 8 != t.keyCode) || window.Quill.find(n.img).deleteAt(0), n.hide());
            }),
            (this.quill = e);
          var s = !1;
    ...
    function(t, e, n) {
      ...
      (s["[object Float32Array]"] = s["[object Float64Array]"] = s["[object Int8Array]"] = s[
        ...
        (s["[object Arguments]"] = s["[object Array]"] = s["[object ArrayBuffer]"] = s[
          "[object Boolean]"
        ] = s["[object DataView]"] = s["[object Date]"] = s["[object Error]"] = s["[object Function]"] = s[
          "[object Map]"
        ] = s["[object Number]"] = s["[object Object]"] = s["[object RegExp]"] = s["[object Set]"] = s[
          "[object String]"
        ] = s["[object WeakMap]"] = !1),
        (t.exports = o);
    },

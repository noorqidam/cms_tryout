              ...
              <tr v-for="(pesertaUjian, index) in dataPeserta" :key="index">
                ...
                <td>
                  <span
                    ...
                    >Details</span
                  >
                  <!-- <button class="badge badge-success btn ml-2" @click="_actionSendEmail(pesertaUjian)">
  ...
  methods: {
    ...
    _actionSendEmail(data) {
      ...
      a.push({
        ...
        judul_quiz: "Ujian bersama Adzim",
        penyelenggara: "SKY-LAN",
        waktu_pelaksanaan: "17 Februari 2020 - 17 Februari",
        jumlahsoal: data.totalSoal,
        skor: data.score,
        jawaban_benar: 8,
        jawaban_salah: 2
      });

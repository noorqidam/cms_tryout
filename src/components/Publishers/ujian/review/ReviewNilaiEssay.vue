<template>
  <div v-if="isLoading === true" class="hello">
            ...
            <table class="table table-hover">
              <thead>
                ...
                <tr>
                  <td>Nilai PG</td>
                  <td>
                    :<span v-if="total_nilai_pg < 70" class="badge badge-danger"
                      >{{ total_nilai_pg }}/100</span
                    >
                    <span v-else-if="total_nilai_pg >= 70" class="badge badge-success">
                      {{ total_nilai_pg }}/100
                    </span>
                  </td>
                </tr>
                <tr>
                  <td>Nilai Essay</td>
                  <td>
                    :<span v-if="total_nilai < 70" class="badge badge-danger">{{ total_nilai }}/100</span>
                ...
                <div class="col-md-12 mb-3">
                  <div class="row">
                    <div class="col-md-6 col-6">
                      ...
                      <span
                        v-if="hasil.point >= 60 && hasil.isReviewed == true"
                      ...
                      <span
                        v-else-if="hasil.point < 60 && hasil.isReviewed == true"
                      ...
                      <span
                        v-if="hasil.isReviewed == false && hasil.point < 1"
    ...
    <div v-else class="col-md-12 text-center">
      <button class="btn btn-success" @click="showModalEnd = true">
        Beri Nilai AKhir
      </button>
      <div class="col-md-12">
        <b-modal v-model="showModalEnd" size="md" hide-footer hide-header header-bg-variant="info">

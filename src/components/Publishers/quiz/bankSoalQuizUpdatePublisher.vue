            ...
            <div class="card-body">
              <div class="col-md-12">
                <div class="form-group row">
                  <!-- <label for="" class="col-sm-1 pt-1">Cari</label> -->
                  <div class="col-sm">
                    <input
                      type="text"
                  ...
                  <div class="col-sm-auto">
                    <router-link
                      :to="{ path: '/p/quiz/cart-edit-soal-quiz', query: { _id: quiz_id } }"
                      class="btn btn-sm"
                    >
                      Cart Soal
...
export default {
  ...
  watch: {
    currentPage() {
      if (this.$route.query.matpel || this.$route.query.level) {
        ...
        this._acrtionQuerySoal(matpel, level);
      } else {
        console.log("get all");
        this._actionGetAll();
      }
  ...
  methods: {
    ...
    _acrtionQuerySoal(matpel, level) {
      if (matpel) {
        if (matpel && level) {

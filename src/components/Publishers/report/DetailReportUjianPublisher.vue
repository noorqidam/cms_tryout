        ...
        <div class="table-responsive">
          <table class="table table-sm table-striped table-hover">
            <thead class="bg-dark text-white">
              ...
              <tr class="bg-white text-dark">
                <th v-for="(row, index) in tablee" :key="index" class="text-center">PG/ESY/NA</th>
              </tr>
            </thead>
            <tbody class="text-center">
              <tr v-for="(items, index) in reportPeserta" :key="index">
                ...
                <td class="text-left">{{ items.email }}</td>
                <td v-for="(items2, index) in items.sesi" :key="index">
                  <span v-if="items2.is_review == false">Belum dinilai</span>
